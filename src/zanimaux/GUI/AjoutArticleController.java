...
//                
        ...
        public void resetTableData() throws SQLException
    {
        ...
        Articleservice as = new Articleservice();
         listArticles = (List<Articles>) as.getAllByVet(Session.getLoggedInUser().getCin());
        ObservableList<Articles> data = FXCollections.observableArrayList(listArticles);
        table_list_article.setItems(data);
    }
    ...
    private void GoBack(ActionEvent event) {
             ...
             try {
                 ...
                 Stage myWindow = (Stage) iv.getScene().getWindow();
                 Scene sc = new Scene(root);
                 myWindow.setScene(sc);
                 myWindow.setTitle("DashBoard");
                 myWindow.show();
             } catch (IOException ex) {
                 Logger.getLogger(LoginController.class.getName()).log(Level.SEVERE, null, ex);
             }
